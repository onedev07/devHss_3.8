    ...
    <div class="card shadow mb-4">
		...
		<div class="paginator">
			<ul class="pagination">
				...
				<li><?= $this->Paginator->first('<< ' . __('Premier')) ?></li>
				<li><?= $this->Paginator->prev('< ' . __('Pécédent')) ?></li>
				<li><?= $this->Paginator->numbers() ?></li>
				<li><?= $this->Paginator->next(__('Suivant') . ' >') ?></li>
				<li><?= $this->Paginator->last(__('Dernier') . ' >>') ?></li>			
				
			</ul>
			<p><?= $this->Paginator->counter(['format' => __('Page {{page}} sur {{pages}}, affiche {{current}} enrégistrement(s) sur {{count}} total')]) ?></p>
		</div>
