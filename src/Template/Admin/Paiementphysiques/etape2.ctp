...
<div class="container-fluid">
    ...
    <div class="card shadow mb-6">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Etape 2 - Effectuer le Paiement physique</h6>
        </div>
        <div class="card-body">
            <?= $this->Form->create($paiementphysique) ?>			
			
            <div class="form-group">
                <?= $this->Form->control('physclient_id', ['type' =>'hidden', 'name' => 'physclient_id', 'id' =>'physclient_id','class' => 'form-control', 'value' => $idClient, 'label' => 'Client:']); ?>
            </div>
            <div class="form-group">
