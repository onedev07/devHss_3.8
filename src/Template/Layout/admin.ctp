...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href=<?= $this->Url->build(['controller' => 'Dashboards', 'action' => 'index']) ?>>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= $this->Url->build(['controller' => 'Dashboards', 'action' => 'index']) ?>">
			...
			<li class="nav-item">
                <a class="nav-link" href=<?= $this->Url->build(['controller' => 'Paiements', 'action' => 'index']) ?>>
                    ...
                    <span><strong>PAIEMENTS ELECTRONIQUES</strong></span></a>
            </li>
			
			<li class="nav-item">
                <a class="nav-link" href=<?= $this->Url->build(['controller' => 'Paiementphysiques', 'action' => 'index']) ?>>
                    <i class="fas fa-fw fa-credit-card"></i>
                    <span><strong>PAIEMENTS PHYSIQUES</strong></span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href=<?= $this->Url->build(['controller' => 'Offres', 'action' => 'index'])  ?>>
                    ...
                    <span><strong>OFFRES SMART</strong></span></a>
            </li>
            <li class="nav-item">
                  <a class="nav-link" href=<?= $this->Url->build(['controller' => 'gpsoffres', 'action' => 'index'])  ?>>
                      <i class="fas fa-fw fa-car"></i>
                      <span><strong>OFFRES GPS</strong></span></a>
              </li>
			<li class="nav-item">
                <a class="nav-link" href="<?= $this->Url->build(['controller' => 'Clients', 'action' => 'client'])  ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span><strong>CLIENTS ELECTRONIQUES</strong></span></a>
            </li>
			<li class="nav-item">
                <a class="nav-link" href="<?= $this->Url->build(['controller' => 'Physclients', 'action' => 'index'])  ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span><strong>CLIENTS PHYSIQUES</strong></span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href=<?= $this->Url->build(['controller' => 'Clients', 'action' => 'prospect'])  ?>>
                    <i class="fas fa-fw fa-users"></i>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Voulez-vous quitter votre session?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Cliquez sur le bouton déconnexion si vous voulez quitter votre session.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'logout'])  ?>">Déconnexion</a>
                </div>
            </div>
        </div>
    </div>
